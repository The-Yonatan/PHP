...
<body>
    ...
    <nav><A HREF = "page1.php" >Home</A><br> Catagories <br> <A HREF = "page1.1.php" >TV</A><br> <br> <A HREF = "page1.2.php" >Sound Syetem</A> <br><br> <A HREF = "page1.3.php">Unlocked Phone</A> <br><br><A HREF = "page1.4.php">Camaeras</A> <br></nav>
    <div id = php>
    <?php
    ...
    /// this for loop prits items from our jason array 
    ///items from index 4 to 8 because we only have 4 sound bar items   
    for ( $i = 4; $i < 8; $i++ ){
