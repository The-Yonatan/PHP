...
<body>
    ...
    <nav><A HREF = "page1.php" >Home</A> <br> Catagories <br> <A HREF = "page1.1.php" >TV</A><br> <br> <A HREF = "page1.2.php" >Sound Syetem</A> <br><br> <A HREF = "page1.3.php">Unlocked Phone</A> <br><br><A HREF = "page1.4.php">Computers</A> <br></nav>
    <div id = php>
    <?php
    ...
    $items = json_decode($data, true);
        /// this for loop prints items from our jason array 
    ///items from index 12 to 15 because we only have 3 laptop items  
    for ( $i = 12; $i < 15; $i++ ){
