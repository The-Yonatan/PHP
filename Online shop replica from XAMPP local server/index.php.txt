...
<body>
    ...
    $query_string = "SELECT * FROM catalogue";
    ...
    while ( $data = $cursor->fetchObject() ) {
       ...
       echo "<table class = \"table\"><tr>";
        ...
        echo "</td><td>";
        echo "<button onclick=\"doAdd('$data->product_name')\" >Add to Cart</button>";
        echo "</tr></table>";
...
<?php
    ...
    <script>
       function doAdd(item) {
        ...
        /*document.getElementById("table").innerHTML+=$_SESSION['cart'];*/
}
    </script>
